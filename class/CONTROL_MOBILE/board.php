<?
	...
	class Board extends BoardMOL {
		...
		/*관리자 게시판 관리 리스트 출력*/
		public function boardMngList($page="", $setOrder="", $code=""){
			$returnVal = "";
		...
		public function boardInsertMng($setBeen){
			...
			$boardSetBeen = array($setBeen[3], $insertMaxThread, "1", $setBeen[2], $setBeen[0], $setBeen[1], $_SERVER["REMOTE_ADDR"], "0", $setBeen[4]);
			parent::setBoardDataMOL($boardSetBeen);
