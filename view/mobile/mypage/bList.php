<?
	...
	$rtnList = $mypage->boardListM($page, $orderBy);
?>        
        ...
        <div style="padding:0px 10px;">
			...
			<?=$rtnList?>
                <!--<dt>
                    ...
                    <span style="color:#333;display:block;padding-top:10px;clear:both;">점집 분위기가 아늑하고 하주 편안해요</span>
                </dt>
                <dd>
                    <p>점집 분위기는 아늑하고 아주 깔끔해서 좋았습니다. 질문을 하면 답변을 상세하고 조목조목 알려주셨고 예방하는 방법까지 알려주셨...</p>

                    <div style="text-align:right;margin-top:15px;">
                        <input type="button" value="상세보기" class="btn_2 btn_s" onclick="location.href = 'mw_member3_view.html';" />
                    </div>
                </dd>
                ...
                <dt>
                    ...
                    <span style="color:#333;display:block;padding-top:10px;clear:both;">신통하게 잘 맞추네요~</span>
                </dt>
                <dd>
