<?
	...
	$rData = $shaman->shamanHomeInfoMDaum($shamanData);
...
<script>
	...
	function setDaumMap(){
		...
		mapOption = { 
			center: new daum.maps.LatLng(<?=$rData["SHLng"]?>,<?=$rData["SHLat"]?>), // 지도의 중심좌표
			level: 5 // 지도의 확대 레벨
		};
		...
		// 마커가 표시될 위치입니다 
		var markerPosition  = new daum.maps.LatLng(<?=$rData["SHLng"]?>, <?=$rData["SHLat"]?>); 
