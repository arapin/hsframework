...
<input type="hidden" name="SHLat" value=""/>
		...
		<fieldset class="login_field" style="padding:20px 17px 25px 17px;">
            <div class="id_search_guide">
                무속인 점집 등록을 하면 점(占)의<br />
                <a href="" class="link2">이용약관</a>, 
                <a href="" class="link2">개인정보취급방침</a>, 
                <a href="" class="link2">청소년보호정책</a> 에<br />
                동의하게 됩니다.
            </div>
            <div style="display:table; width:100%;">
                <div style="display: table-cell; padding-right: 10px;">
                    <input type="text" placeholder="아이디" name="SHId" onkeyup="checkIdStringMng();"/>
                </div>
            ...
            <input type="password" placeholder="비밀번호" name="SHPwd"/>
            <input type="password" placeholder="비밀번호 확인" name="SHPwdConfirm"/>
            <input type="text" placeholder="무속인명" name="name"/>
            <input type="text" placeholder="상호명" name="SHName"/>
            <div>
                <input type="text" value="" id="zipcode" name="SHZipcode" style="width:120px; float:left;margin:0px 10px 10px 0px;" />
                <input type="button" value="우편번호 찾기" class="btn_6" style="width:110px; float:left; margin-bottom:10px;" onclick="execDaumPostcode()"/>
            </div>
            <input type="text" placeholder="기본주소" name="SHAddress" id="address"/>
            <input type="text" placeholder="상세주소"  name="SHAddress2" id="address2"/>
            <input type="text" placeholder="휴대폰번호 - 제외하고 입력하여 주세요" name="SHPhone"/>
            <input type="text" placeholder="이메일" name="SHEmail"/>

            <input type="button" value="무료 점집 등록하기" style="margin-top:10px;" class="btn_4" onclick="form_chk_front();"/>

            <div style="text-align:center;padding:20px 0px;">
                이미 점(占) 무속인 회원이시면 <a href="?com=user&lnd=login" class="link2">로그인</a> 하세요.
            </div>
        </fieldset>
</form>
