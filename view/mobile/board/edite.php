...
<?}?>
            ...
            <textarea style="width:100%; height:240px; border:1px solid #c3c3c3; color:#666; box-sizing:border-box; padding:10px; font-size:14px; border-radius:2px;" placeholder="내용을 적어주세요" name="content"><?=$content?></textarea>

            <div class="ctl_half" style="padding-top:20px;">
                <div class="ctl_half_t1">
                    <input type="button" class="btn_1" value="수정" onclick="modifyChk();" />
                </div>
