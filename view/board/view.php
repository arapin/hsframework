<?
	...
	$mList = $board->getMemoList($memoBeen);
	$title = $rData["title"];
...
?> 
        ...
        <div class="sub_content sub_content_max">
            ...
            <input type="button" class="b_list_btn float_right" style="margin:30px 0px 0px 0px;" value="목록으로" onclick="location.href = '?com=board&lnd=list&code=<?=$code?>';" />
...
<?}?>
            ...
            <input type="button" value="목록으로" class="float_right b_list_btn" style="margin-top:-70px;" onclick="location.href = '?com=board&lnd=list&code=<?=$code?>';" />
        </div>
        <!-- 본문 끝 -->