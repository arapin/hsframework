...
<input type="hidden" name="pwd" value="<?=$rData["pwd"]?>" />
        ...
        <div class="sub_content" style="margin-left: 0px; width: 1024px;">
            <h3 class="sub_h3">회원정보</h3>
            <ul class="l_style_left sub_site_map">
                <li>HOME >&nbsp;</li>
                <li>마이페이지 >&nbsp;</li>
                <li class="text_bold">회원정보</li>
            </ul>

            <div class="login_wrap" style="margin-bottom:40px; width:540px; height:740px;">
                <fieldset class="login_form">
                    ...
                    <div class="join_width">
                        ...
                        <input type="password" value="" id="txtPassword" name="pwdU"/>
                        <br />

                        <label class="join_label" for="txtChkPwd">
                            <img src="/images/li3.gif" alt="" />비밀번호확인<span class="req_mark">*</span>
                        </label>
                        <input type="password" value="" id="txtChkPwd" name="pwdUConfirm"/>
                        <br />
