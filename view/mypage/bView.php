...
?> 
        ...
        <div class="sub_content" style="width: 784px; min-height:650px;">
            ...
            <input type="button" class="b_list_btn float_right" style="margin:30px 0px 0px 0px;" value="목록으로" onclick="location.href = 'com=mypage&lnd=bList>';" />
...
<?}?>
			...
			<form name="memoForm" method="post" action="?com=mypage&pro=mypageinfo">
...
<?}?>
            ...
            <input type="button" value="목록으로" class="float_right b_list_btn" style="margin-top:-70px;" onclick="location.href = '?com=mypage&lnd=bList';" />
        </div>
        <!-- 본문 끝 -->