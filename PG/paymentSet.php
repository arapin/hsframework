...
********************************************************************************/
	...
	****************************************************************************/
	...
	$agspay->SetValue("AgsPayHome","/home/hosting_users/godfortune/www/PG");			//올더게이트 결제설치 디렉토리 (상점에 맞게 수정)
...
<form name=frmAGS_pay_ing method=post action="?com=shopping&lnd=result">
